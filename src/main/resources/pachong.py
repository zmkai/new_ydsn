...
def student_score(account):
    ...
    for i in result:
        ...
        print(len(result2))
        # print(result2)http://jwc.syau.edu.cn/JiGouSZ/
        for j in result2:      
            courseId = j[0]
            ...
            print(gradeId,account,courseId,courseNumber,courseName,credit,type,grade,testTime,notPassedCause,gradeType,description)
            # print('-'*100)
...
# </td>\r\n\r\n<td>&nbsp;(.*?)</td>\r\n\r\n<td>&nbsp;(.*?)</td>\r\n\r\n<td>&nbsp;(.*?)</td>\r\n\r\n<td>&nbsp;(.*?)\
# </td>\r\n\r\n<td>&nbsp;(.*?)</td>\r\n\r\n(.*?)</tr>'''
# [('M901130462', 'teacherXkAction.do?actionType=1&kcId=M90113046201',
#  'JAVA语言及程序设计', '01', '2', '73', '1-10周上', '7', '11~12', '路南校区', '实践上课地点', '具体地点教师通知10'),
...
# 问题：1.用户注销后重新登录 判断成新用户
# 如果不删除个人信息重新爬取的话改密码怎么办
# 注销和第一次登录
# 删除一个账号的所有课程，重新爬取浪费时间，如果不重新爬取的话没用的课程会一直保存